...
compute_enbs <- function (evsi_ar, nb, c_fix, c_var, lag_awr, lag_oir,
  ...
  # lag_awr:  Time between end of follow-up and change of practice for AWR (range or value).
  # lag_oir:  Time between end of follow-up and change of practice for OIR (range or value).
