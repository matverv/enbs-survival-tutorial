...
# List of matrices with survival probabilities of interest (OS)
...
v_cens_times1 <- with(ipd_os, times[treat == 1 & event == 0])
v_cens_times2 <- with(ipd_os, times[treat == 2 & event == 0])
