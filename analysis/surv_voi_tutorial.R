...
gen_surv_data_ongoing <- function(surv_probs, atrisk_times, dropout_pars, add_fu_months, cycles_per_year) {
  # Arguments:
    ...
    # atrisk_times:    Vector of observed follow-up times in months for the patients at risk corresponding to the 
    #                  treatment and survival outcome in `surv_probs`.
    # dropout_pars:    Gamma hyperparameters for exponential dropout rate (number of dropouts, time at risk in months).
